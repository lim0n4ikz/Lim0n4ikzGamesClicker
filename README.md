...
## 🚀 Последняя версия (Просто скачайте EXE файл)
...
# 🐍 Запуск из исходного кода (Не рекомендуется для среднестатистических пользователей)
...
## 🔨 Способы сборки (Не рекомендуется для среднестатистических пользователей)
